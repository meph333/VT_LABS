...
namespace LAB07
{
    public partial class Form1 : Form
    {
        ...
        private void InitListBox()
        {
            ...
            //    "DateTimePicker"
            listBox.Items.Add("DateTimePicker");
            //    "NumericUpDown"
            listBox.Items.Add("NumericUpDown");
            //    "PictureBox"
            listBox.Items.Add("PictureBox");
            //    "TrackBar"
            listBox.Items.Add("TrackBar" );
            //    "Timer
            listBox.Items.Add( "Timer" );
            //    "ProgressBar"
            listBox.Items.Add("ProgressBar" );
            //    "ComboBox"
            listBox.Items.Add( "ComboBox" );
            //    "MessageBox"
            listBox.Items.Add( "MessageBox" );
            //    "ColorDialog"
            listBox.Items.Add( "ColorDialog" );
            //    "OpenFileDialog"
            listBox.Items.Add( "OpenFileDialog" );
            //    "FontDialog"
            listBox.Items.Add( "FontDialog" );
            //    "Немодальное окно"
            listBox.Items.Add( "Немодальное окно" );
