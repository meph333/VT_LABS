...
namespace LAB02
{
    ...
    public class Solver
    {
        ...
        public static string RublesToDollars(double rubles)
        {
            ...
            double dollars = rubles / 2.94;
            
            return $"{rubles} рублей = {(int)dollars} долларов";
        }
        ...
        public static string GetQuadrant(double x, double y)
        {
            if (x > 0 && y > 0)
                ...
                return "Точка (0, 0) находится на пересечении четвертей";
            else if (x == 0)
        ...
        public static string FibonacciSum(int n)
        {
            ...
            if (n == 1)
                return "Сумма Первых 1 чисел Фибоначчи = 0";
            long sum = 0;
            long fib1 = 0;
            long fib2 = 1;
